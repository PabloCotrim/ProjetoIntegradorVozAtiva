# ProjetoIntegradorVozAtiva 
A proposta desse modelo e rede-social, eu e meu grupo iremos fazer um back-end para uma rede social chamada "Voz Ativa", nele será possível manipular os dados das "postagens" dos usuarios.
